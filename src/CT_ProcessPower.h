...
class CTPROCESSOR
{
  ...
  String jsonPost_template = F("json:{\"msg\":{\"source\":\"[SOURCE]\",\"data\":[{\"voltage\":\"[VOLTAGE]\", \"power\":\"[POWER]\", \"wh\":\"[WH]\", \"MTD_wh\":\"[MTD_WH]\", \"YTD_wh\":\"[YTD_WH]\"}]}}");
  /* 
  "json:{'msg':{'source':'[SOURCE]','data':[{'voltage':'[VOLTAGE]', 'power':'[POWER]', 'wh':'[WH]', 'MTD_wh':'[MTD_WH]', 'YTD_wh':'[YTD_WH]'}]}}";
  */
  String jsonPost = " ";
  char resx[8];
